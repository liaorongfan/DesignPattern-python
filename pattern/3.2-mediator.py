...
from enum import Enum  # Python3.4 之后支持枚举Enum的语法
...
class SpeakerMgr(DeviceMgr):
    ...
    def enumerate(self):
        ...
        devices = DeviceList()
        devices.add(
            DeviceItem("369dd760-893b-4fe0-89b1-671eca0f0224", "Realtek High Definition Audio", DeviceType.TypeSpeaker))
        devices.add(
            DeviceItem("59357639-6a43-4b79-8184-f79aed9a0dfc", "NVIDIA High Definition Audio", DeviceType.TypeSpeaker,
                       True))
        return devices
